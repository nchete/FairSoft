...
import os
wrapsrc = '/home/nathalie/ShipSoft/FairSoft/tools/lhapdf-5.9.1/pyext/lhapdf_wrap.cc'
incdir_src = os.path.abspath('/home/nathalie/ShipSoft/FairSoft/tools/lhapdf-5.9.1/include')
incdir_build = os.path.abspath('../include')
libdir = os.path.abspath('../lib')
cxxargs = '-O3 -std=c++11'.split()
ldargs = ''.split()
